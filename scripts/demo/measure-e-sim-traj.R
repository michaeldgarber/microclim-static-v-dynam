...
#Continued from
#microclim-static-v-dynam/scripts/demo/sim-trajectories.R
...
#Takes about 5 minutes on my comp
...
traj_extract_wrangle_test = traj_extract_e_test %>% 
  ...
  #note this look-up table also has the categorical variables, including 
  #t_elapsed_to_next_overnight
  left_join(
...
traj_extract_wrangle_test %>% View()
